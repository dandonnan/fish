namespace CommuteiOS
{
    ...
    /// <summary>
    /// The platform implementation for an iOS build.
    /// </summary>
    internal class iOSPlatform : IPlatform
    {
        ...
        /// <summary>
        /// Create the iOS platform implementation.
        /// </summary>
        /// <param name="graphicsDevice">The graphics device.</param>
        public iOSPlatform(GraphicsDevice graphicsDevice)
        {
        ...
        {
            // No achievements for iOS, so default to false
            return false;
        }
        ...
        {
            // No achievements for iOS, so default to 0
            return 0;
        }
